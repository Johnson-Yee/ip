...
public class DukeException extends Exception {
    ...
    public static final String MISSING_DATE = "You forgot the event date/deadline!";
    ...
    public static final String SET_DATE_FAIL = "The date you have keyed in has already passed.\n Dude.java is not" +
    ...
    public DukeException(String error) {
        ...
        case "MISSING_QUALIFIER":
            ...
            break;
        case "MISSING_DATE":
            this.errorMessage = MISSING_DATE;
            break;
        case "MISSING_NUMBER":
